...
const useCommands = (ref, nativeRef, mentionIndicators, nextHtmlRequestId, pendingHtmlRequests) => useImperativeHandle(ref, () => {
  ...
  return {
    ...
    setMention: (indicator, text, type, attributes) => {
      ...
      Commands.addMention(nullthrows(typedRef), indicator, text, type, parsedAttributes);
    },
    ...
    addContent: (text, type, src, attributes) => {
