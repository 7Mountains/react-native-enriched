...
export declare const EnrichedReanimatedTextInput: ({ ref, automaticallyAdjustsScrollIndicatorInsets, automaticallyAdjustContentInsets, autoFocus, editable, mentionIndicators, defaultValue, placeholder, placeholderTextColor, cursorColor, selectionColor, style, autoCapitalize, htmlStyle, onFocus, onBlur, onChangeText, onChangeHtml, onChangeState, onLinkDetected, onMentionDetected, onStartMention, onChangeMention, onEndMention, onChangeSelection, onColorChangeInSelection, onParagraphAlignmentChange, onContextMenuItemPress, contentInsets, androidExperimentalSynchronousEvents, scrollEnabled, dragAndDropEnabled, bouncesVertically, contextMenuItems, keyboardDismissMode, onKeyPress, onScroll, writingToolsBehavior, ...rest }: Props) => import("react/jsx-runtime").JSX.Element;
export {};
